...
@Testcontainers
public abstract class AbstractTestconstainersUnitTest {
    ...
    /**Notice : This is how we connect our application to the test container postgres instance that we have running with docker */
